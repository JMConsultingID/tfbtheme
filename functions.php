...
add_filter('woocommerce_order_needs_authentication', 'disable_authentication_for_order_pay', 10, 2);

function disable_authentication_for_order_pay($needs_auth, $order) {
